...
![Gif](./assets/images/cronometro.gif)
...
O Cronômetro foi desenvolvido com HTML5, CSS3 e JavaScript. Conta com 3 botões (play, pause e reset), que são manipuladores de eventos para alcançar o funcionamento do cronômetro.

## 🏁 Instalação:

Antes de começar, é bom ter um editor para trabalhar com o código, como: [VSCode](https://code.visualstudio.com/). Clone este repositório usando git clone: https://github.com/otaviopdev/Cronometro.git ou clique em Code/Download ZIP. Clique no arquivo "index.html" e veja a aplicação.
...
Este projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/otaviopdev/Cronometro/blob/main/LICENSE) para mais detalhes.
